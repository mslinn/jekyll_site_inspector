...
module JekyllPluginNameSiteInspector
  PLUGIN_NAME = 'site_inspector'.freeze
end
...
PluginMetaLogger.instance.info { "Loaded #{JekyllPluginNameSiteInspector::PLUGIN_NAME} v#{JekyllSiteInspectorVersion::VERSION} plugin." }
